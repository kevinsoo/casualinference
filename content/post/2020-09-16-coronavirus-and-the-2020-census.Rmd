...
It's been awhile since I posted anything, which has been due to my being stretched thin at my job (on top of trying to survive a pandemic). I've been working with the [National Conference on Citizenship (NCoC)](https://ncoc.org/) to monitor the progress of the census, which determines how federal funding and congressional seats are apportioned to the different states. 
